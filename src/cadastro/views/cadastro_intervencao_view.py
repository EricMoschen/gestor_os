...
from src.cadastro.selectors.intervencao_selectors import listar_intervencoes_com_os
from src.cadastro.services.intervencao_service import salvar_intervencao, remover_intervencao
